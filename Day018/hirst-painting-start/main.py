...
# Hirst spot painting, extract the colors from the image, only once.

# import colorgram
#
# rgb_colors = []
# colors = colorgram.extract('image.jpg', 30)  #color.rgb needed
# for color in colors:
#     r = color.rgb.r
#     g = color.rgb.g
#     b = color.rgb.b
...
tim.speed("fast")
tim.penup() #not to draw the lines
tim.hideturtle() #not to show the arrow
